  ...
  return (
    <>
      ...
      <div className="border-t-[1px] border-black">
        <div className="w-[940px] mx-auto mb-[100px] h-[2000px]">
          <div
          ...
          >
            ...
            <div className="p-2 " style={{ background: "#2a475e" }}>
              <p className="text-[#acb2b8] mt- items-center">
                Đánh giá được viết trước ngày 28 Thg09, 2023 @ 5:30am là dành
                cho CS:GO, phiên bản cũ của Counter-Strike 2.
              </p>
            </div>
...
<div>
                ...
                >
                  <div>
                    ...
                    <p>
                      Người chơi {game[0]?.title} có cùng trạng thái Prime được
                      xếp trận với nhau, và được nhận quyền lợi dành riêng cho
                      Prime như đồ lưu niệm, vật phẩm rơi ngẫu nhiên, và hòm vũ
                      khí. Sản phẩm này không đủ điều kiện để được hoàn tiền
                    </p>
                    <p className="py-2">
                      Gói này trao trạng thái Prime cho tài khoản{" "}
                      {game[0]?.title}.
                    </p>
                    <span className="py-2">
                      Sản phẩm này không đủ điều kiện để được hoàn tiền
                ...
                >
                  <span>
                    Sản phẩm này không đủ điều kiện để được hoàn tiền. Tìm hiểu
                    thêm
                  </span>
                </div>
                ...
                >
                  ...
                  <p className="text-[#acb2b8] my-2">
                    Trong hai thập kỷ qua, Counter-Strike đã mang lại trải
                    nghiệm thi đấu cao cấp, được nhào nặn bởi hàng triệu người
                    chơi trên toàn cầu. Và giờ chương tiếp theo của câu chuyện
                    CS chuẩn bị khởi màn. Đây là Counter-Strike 2
                  </p>
                  <p className="text-[#acb2b8] my-4">
                    Là phiên bản nâng cấp miễn phí của CS:GO, Counter-Strike 2
                    là bước nhảy vọt lớn nhất về công nghệ trong lịch sử
                    Counter-Strike. Xây dựng trên engine Source 2,
                    Counter-Strike 2 được hiện đại hóa với hệ thống dựng hình
                    dựa trên quy tắc vật lý ở thế giới thực (physically-based
                    rendering), hệ thống hạ tầng mạng tiên tiến, và công cụ
                    workshop dành cho cộng đồng đã cải tiến.
                  </p>
                  <p className="text-[#acb2b8] my-4">
                    Ngoài lối chơi kinh điển tập trung vào nhiệm vụ mà
                    Counter-Strike đã khai phá từ năm 1999, Counter-Strike 2 bao
                    gồm các tính năng sau:
                  </p>

                  <ul class="list-disc list-inside">
                    <li>
                      Hệ số CS hoàn toàn mới kèm theo chế độ Premier cập nhật
                    </li>
                    <li>Bảng xếp hạng toàn cầu và khu vực</li>
                    <li>Bản đồ màn chơi được nâng cấp và đại tu hoàn toàn</li>
                    <li>
                      Lựu đạn khói được thay đổi linh hoạt, thay đổi cuộc chơi
                    </li>
                    <li>Lối chơi hoạt động độc lập với hệ thống tick-rate</li>
                    <li>Âm thanh và đồ họa được thiết kế lại</li>
                    <li>Tất cả vật phẩm từ CS:GO đều được mang tới CS2</li>
                ...
                >
                  ...
                  <p className="text-[#acb2b8]">HĐH: Windows® 10</p>
                  <p className="text-[#acb2b8]">
                    Bộ xử lý: Vi xử lý với 4 luồng phần cứng - Intel® Core™ i5
                    750 trở lên
                  </p>
                  <p className="text-[#acb2b8]">Bộ nhớ: 8 GB RAM</p>
                  <p className="text-[#acb2b8]">
                    Đồ họa: Card màn hình phải từ 1 GB trở lên và nên tương
                    thích với DirectX 11 với hỗ trợ Shader Model 5.0
                  </p>
                  <p className="text-[#acb2b8]">DirectX: Phiên bản 11</p>
                  <p className="text-[#acb2b8]">
                    Lưu trữ: 85 GB chỗ trống khả dụng
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    <p className="text-[#acb2b8] mt-2">
                      13,377 thẩm định viên đã đánh giá sản phẩm này. Nhấp vào
                      đây để xem.
                    </p>
                  </div>
                </div> */}
              ...
              <div className="float-right w-[308px] ml-[14px]  overflow-hidden">
                ...
                >
                  <p>
                    Đăng nhập để thấy lí do bạn có thể thích hoặc không thích
                    sản phẩm này dựa trên các trò chơi, bạn bè và thẩm định viên
                    đang theo dõi.
                  </p>
                  <div className="flex  items-center justify-between mt-2">
                    <Link
