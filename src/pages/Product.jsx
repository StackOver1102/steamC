          ...
          >
            ...
            <div className=" border-t-[1px] border-black">
              ...
              <div className=" float-left w-[616px] mt-2 ">
                ...
                >
                  ...
                  <div className="w-[60%] flex flex-col">
                    ...
                    <div className="inline-block cursor-default leading-[13px] mt-2 mb-2">
                      <p>
                        Perry good game play and art, Optimal maybe not good but
                        i believe in moon studio is Conscientious developer
                      </p>
                    </div>
                ...
                >
                  <h1 className="text-center text-[16px] text-[#67c1f5] pt-[30px] mb-[20px]">Không còn đánh giá nào khớp với bộ lọc trên.</h1>
                  <p className="text-[14px] text-[#898A8C] text-center px-4 ">Chỉnh bộ lọc ở trên để xem thêm đánh giá khác</p>
                </div>
              </div>
              {/* right */}
            </div>
